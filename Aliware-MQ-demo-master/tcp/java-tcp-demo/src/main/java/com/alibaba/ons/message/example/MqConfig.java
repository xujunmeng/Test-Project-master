...
public class MqConfig {
     ...
     */
    public static final String TOPIC = "test_topic_junmeng_1";
    public static final String PRODUCER_ID = "PID_junmeng_1";
    public static final String CONSUMER_ID = "CID_junmeng_1";
    ...
    public static final String ACCESS_KEY = "LTAIglSpYNV3EvoA";
    public static final String SECRET_KEY = "O0K1Lcs4DEnGHtzDtZc3kLUKDD8w7x";
